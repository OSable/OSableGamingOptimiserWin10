...
$Form.text                       = "Windows 10 Gaming & Streaming Optimiser from OSable"
...
$Panel3.controls.AddRange(@($essentialundo,$RBackgroundApps,$HTrayIcons,$EClipboardHistory,$ELocation))
